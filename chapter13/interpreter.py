...
def validate_action():
    input_msg = 'What action would you like? '
...
def main():
    ...
    # TODO: make it interactive. Currently, all
    #  the events are hardcoded in the tests tuple. However, the user wants to be able to activate
    #  events using an interactive prompt.
    # tests = ('open -> gate',
    #          'close -> garage',
    ...
    #          # TODO: check how sensitive pyparsing is regarding
    #          #  spaces, tabs, or unexpected input.
    ...
    while not valid_input:
        valid_input, action = validate_action()
    print()
    tests = [action]
